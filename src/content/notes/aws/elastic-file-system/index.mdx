...
- Multiple [EC2 instances](./elastic-compute-cloud) can access the same EFS file system concurrently.
...
- **Regional**: stores data across multiple [Availability Zones](./availability-zones) within the same [Region](./regions) and is the recommended option for higher availability.
