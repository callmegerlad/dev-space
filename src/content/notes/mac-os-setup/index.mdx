...
- [ ] [Raycast](https://www.raycast.com/), a replacement to the built-in Spotlight feature
	...
	![Raycast quick calculations](./assets/raycast-quick-maths.png)
	
	- And, it even has a store for community-built extensions. Honestly, this is one of those tools I can't imagine switching back from.
